...
<option value="select" selected>Select</option>
  ...
  <option value="mysore">Mysore</option>
		...
		<tbody id="myTable">
			...
			<%
				try {
					...
					String sql = "Select *from select_bank2" ;
					...
					<tbody id="myTable">
						...
						<td ><a href="mark2.jsp?id=<%=rs.getInt(1) %>"> Mark As favourite </td>	
					</tbody>
					<%
					}
    ...
    <li ><a href="bank1.jsp">2</a></li>
    <li class="active"><a href="bank2.jsp">3</a></li>
